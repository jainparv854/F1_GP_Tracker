# F1_GP_Tracker
Tracks Grand Prix, driver and team points and standings, more to add in future.

Development hurdles:
- Needed to understand how header files work and how to connect them to the main file and other files.
- Since Powershell was being stupid, had to commit files manually into the github
